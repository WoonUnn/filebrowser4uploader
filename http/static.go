...
func handleWithStaticData(w http.ResponseWriter, _ *http.Request, d *data, fSys fs.FS, file, contentType string) (int, error) {
	...
	data := map[string]interface{}{
		...
		"UploadingMethod":       d.settings.Uploading.Method,
		"UploadingLog":          d.settings.Uploading.Content.Log,
		"UploadingImage":        d.settings.Uploading.Content.Image,
		"UploadingVideo":        d.settings.Uploading.Content.Video,
